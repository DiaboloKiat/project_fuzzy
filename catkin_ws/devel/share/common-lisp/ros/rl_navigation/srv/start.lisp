...
(cl:defmethod cl:initialize-instance :after ((m <start-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'start-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rl_navigation-srv:<start-request> is deprecated: use rl_navigation-srv:start-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <start-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'start-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rl_navigation-srv:<start-response> is deprecated: use rl_navigation-srv:start-response instead.")))
