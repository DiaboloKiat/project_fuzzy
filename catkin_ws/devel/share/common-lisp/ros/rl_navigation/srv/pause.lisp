...
(cl:defmethod cl:initialize-instance :after ((m <pause-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'pause-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rl_navigation-srv:<pause-request> is deprecated: use rl_navigation-srv:pause-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <pause-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'pause-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rl_navigation-srv:<pause-response> is deprecated: use rl_navigation-srv:pause-response instead.")))
